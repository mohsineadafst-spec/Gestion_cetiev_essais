<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Créer un nouveau laboratoire') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('laboratoires.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <input type="email" id="email_principal" name="email_principal" value="{{ old('email_principal') }}"
